...
def diagnostico(request):
    headers={
        'username' : "andersonpedroza3@gmail.com", # Here enter your API user name
        'password': "De78Qos6MRg94Fkd3", # Here enter your API password
    }
    
    url = "https://sandbox-authservice.priaid.ch/login" # Be aware that sandbox link is for testing pourpose (not real data) once you get live access you shold use https://authservice.priaid.ch/login
...
def resultados(request):
    ...
    if request.method == 'POST':
        ...
        #generar diagnostico    
        response =requests.get(f'https://sandbox-healthservice.priaid.ch/diagnosis?symptoms=[{sintoms}]&gender={s}&year_of_birth={year}&token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..FE6fKfV7QvD0Qog75j8SPVFuEj20myW-VEJ4W6Lw_bo&format=json&language=es-es')
